...
public class ReservarVueloController implements Initializable {
   ...
   private DatePicker DateSalida;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        origen.setOnAction(e->{LugarSalida=origen.getSelectionModel().getSelectedItem();});
        destino.setOnAction(a->{LugarLlegada=destino.getSelectionModel().getSelectedItem();});
        DateSalida.setOnAction(a ->{fecha_partida=DateSalida.getValue().toString();});
        DateRetorno.setOnAction(a ->{fecha_Regreso=DateRetorno.getValue().toString();});
        cargaSpiner();
        CargarOrigen();
        CargarDestinos();
    ...
    /**
    * metodo que utiliza los datos de destinos txt y los guarda en la variable destino
    */
    ...
    /**
    * metodo que carga el origen del destino
    */
    ...
    /**
    * metodo que carga el contenedor que contiene la ObservableList
    */
    ...
    /**
    * metodo que mediante un ActionEvent presenta la ReservaVuelo2 
    */
    @FXML     
